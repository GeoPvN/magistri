...
<meta http-equiv="content-type" content="application/vnd.ms-excel; charset=UTF-8">
	...
	<script type="text/javascript">
		var aJaxURL		= "server-side/report/out_tech_report.action.php";		//server side folder url
		var aJaxURL1	= "server-side/report/sales_statistics_out.action.php";		//server side folder url
		...
		function getData(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=answer_call_operator&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData1(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=cause_fix&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData2(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=answer_call_hour&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData3(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=answer_call_week&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData4(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=answer_call_day&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData5(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=disconect_couse&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData6(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=unanswer_call_queue&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		function getData7(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=answer_call_queue&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		 ...
		 function getData8(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=unanswer_call_day&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		 ...
		 function getData9(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=unanswer_call_hour&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		 ...
		 function getData10(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=unanswer_call_week&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		 ...
		 function drawFirstLevel(){
			   ...
			   start_time = $('#start_time').val();
			   end_time = $('#end_time').val();
			              $.getJSON("server-side/report/tab_0_out.action.php?start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		 ...
		 function getData11(){
			...
			end_time = $('#end_time').val();
			    ...
			    $.getJSON("server-side/report/sales_statistics_out.action.php?act=answer_call_sec&start="+start_time + "&end=" + end_time + "&agent=" + agent + "&queuet=" + queuet, function(json) {
		...
		$(document).on("click", "#show_report", function () {
			...
			parame.agent	= '';
			parame.queuet = '';
			paramm		= "server-side/report/out_tech_report.action.php";
...
<div id="tabs" style="width: 90%;">
		<div class="callapp_head">ტექნიკური გამავალი<hr class="callapp_head_hr"></div>
		
        <label>სტატუსი</label>
		<select id="change_tab" >
		<option value="0">მთავარი</option>
		<option value="1">ნაპასუხები გამავალი ზარები</option>
		<option value="3">გამავალი ზარების განაწილება</option>
		</select>
		<div class="clear"></div>
