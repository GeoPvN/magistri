...
.badge1[data-badge]:after {
   ...
   box-shadow:0 0 1px #333;
        		...
        		sub_menu = '';
      		    if(url == "#"){
            		...
            		sub_menu += '<ul>';            		
          		    ...
          		    if(page_id == 2){
          		    	var classneed ='id="new_news"';
          		    }
        		      menu += '<li '+classneed+' onclick="parent.location=\'index.php?pg=' + page_id +'\'"><img id="img_'+ page_id +'" src="media/images/icons/'+data.nav[i].icon+'" alt="24 ICON" height="24" width="24"><a id="link_'+ page_id +'" href="index.php?pg=' + page_id +'">' + page_name + '</a></li>';
      		    }
        		i++;
      		});
	...
	$(document).on("click", ".give_me_blue", function () {
		...
		$("#img_11").attr("src","media/images/icons/tabel_blue.png");
